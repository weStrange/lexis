...
3. run `yarn run start` to start the local development server
...
Below is the original Create-react-app log. You can change the project config based on the guides.
